...
export const metadata: Metadata = { title: "মানুষ ও মনোবিজ্ঞান" };
  ...
  return (
    <div className="mx-auto max-w-[1280px] px-4 py-8 md:px-6">
      ...
      <p className="type-body-lg mt-2 max-w-2xl" style={{ color: "var(--color-text-secondary)" }}>
        উপলব্ধি, স্মৃতি, জ্ঞানীয় চাপ, সিদ্ধান্ত গ্রহণ — ডিজাইন-প্রাসঙ্গিক মানব আচরণ ও কগনিশন। এটা মেডিকেল পরামর্শ না।
      </p>
      {topics.length > 0 ? (
